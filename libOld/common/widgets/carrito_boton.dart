...
class BotonCarrito extends StatefulWidget {
  ...
  /// Cuando el icono es aprotado
  final VoidCallback onPressed;

  /// Numero de items en el carrito. Cuando es `0`, no se muestra el numero.
  final int itemCount;
...
class CartButtonState extends State<BotonCarrito>
  ...
  @override
  void didUpdateWidget(BotonCarrito oldWidget) {

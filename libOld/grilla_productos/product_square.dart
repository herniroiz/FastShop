...
import 'package:fast_shop/grilla_productos/product_square_bloc.dart';
...
class ProductSquare extends StatefulWidget {
  ...
  final Stream<List<ItemCarrito>> itemsStream;
...
class _ProductSquareState extends State<ProductSquare> {
  ...
  void _createBloc() {
    _bloc = ProductSquareBloc(widget.producto);
  ...
  Widget _createText(bool isInCart) {
    return Text(
      ...
      style: TextStyle(
        color: isDark(widget.producto.color) ? Colors.white : Colors.black,
